...
```groovy
compile "education.assembly:assembly-client-java:1.2.474"
```
...
* target/assembly-client-java-1.2.474.jar
* target/lib/*.jar
...
*AssemblyApi* | [**getGroupEnrolments**](docs/AssemblyApi.md#getGroupEnrolments) | **GET** /groups/enrolments | List Group Enrolments
