...
import education.assembly.platform.spring.models.ContactRelationship;
...
public class ContactStudents implements Serializable {
   ...
   * @return object
  **/
  @ApiModelProperty(example = "student_contact", value = "Object type")
   ...
   * @return studentId
  **/
  @ApiModelProperty(example = "3", value = "Internal stable ID given to all students on the Platform")
  ...
  public ContactStudents relationship(ContactRelationship relationship) {
