...
public class AssessmentListData implements Serializable {
  ...
  public AssessmentListData object(String object) {
    this.object = object;
    return this;
  }
  ...
  **/
  ...
  public AssessmentListData id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public AssessmentListData name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public AssessmentListData familyId(Integer familyId) {
  ...
  **/
  ...
  public AssessmentListData familyName(String familyName) {
  ...
  **/
  ...
  public AssessmentListData misMappings(List<String> misMappings) {
    this.misMappings = misMappings;
    return this;
  }

  public AssessmentListData addMisMappingsItem(String misMappingsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AssessmentListData assessmentListData = (AssessmentListData) o;
    return Objects.equals(this.object, assessmentListData.object) &&
        Objects.equals(this.id, assessmentListData.id) &&
        Objects.equals(this.name, assessmentListData.name) &&
        Objects.equals(this.familyId, assessmentListData.familyId) &&
        Objects.equals(this.familyName, assessmentListData.familyName) &&
        Objects.equals(this.misMappings, assessmentListData.misMappings);
  }
