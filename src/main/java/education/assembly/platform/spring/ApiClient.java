...
import education.assembly.platform.spring.auth.Authentication;
import education.assembly.platform.spring.auth.HttpBasicAuth;
import education.assembly.platform.spring.auth.ApiKeyAuth;
import education.assembly.platform.spring.auth.OAuth;
import education.assembly.platform.spring.Configuration;


@Component("education.assembly.platform.spring.ApiClient")
public class ApiClient {
    ...
    private String basePath = "https://api-sandbox.assembly.education";
    ...
    public ApiClient(Configuration config) {
        this.restTemplate = config.getTemplate();
        init();
        setBasePath(config.getApiBaseUri());
        addDefaultHeader("accept", "application/vnd.assembly+json; version=1");
    }
    ...
    protected void init() {
        ...
        setUserAgent("Assembly-Java-Client");

        // Setup authentications (key: authentication name, value: authentication).
        authentications = new HashMap<String, Authentication>();
        authentications.put("ApplicationToken", new HttpBasicAuth());
        authentications.put("SchoolToken", new HttpBasicAuth());
